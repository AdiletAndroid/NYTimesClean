package com.example.nytimesclean.most_popular.db.model

import com.example.nytimesclean.most_popular.model.PopularArticle

object PopularEntityConverter {

    fun fromEntity(entity: List<EntityPopular>): List<PopularArticle> {
    ...
    fun toEntity(data: List<PopularArticle>): List<EntityPopular> {
