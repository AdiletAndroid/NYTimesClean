...
import com.example.nytimesclean.popular_details_fragment.PopularDetailsFragment
import com.example.nytimesclean.most_popular.model.PopularArticle
import com.example.nytimesclean.most_popular.ui.adapter.PopularAdapter
...
class PopularArticleFragment :
    ...
    private fun openDetailsPage(popularArticle: PopularArticle) {
        val bundle = Bundle()
        bundle.putParcelable(POPULAR_KEY, popularArticle)
